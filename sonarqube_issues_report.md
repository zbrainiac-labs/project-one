...
**Total Issues: 689** | **Total Rules: 93** (47 txt + 20 SQLCC + 26 SQLFluff)  
**Scan Date: 2026-05-06 (Run #26)**
...
|----------|---------------|-----------------|--------------|--------|
| SonarQube Text Plugin (txt:) | 47 | 10 | 37 | 116 |
| SQL Code Checker (SQLCC:) | 20 | 8 | 13 | 53 |
| SQLFluff (external) | 26 | 26 | 26 | 523 |
| **Total** | **93** | **44** | **76** | **689** |

---

## Community Text Plugin Rules (txt:) — 47 rules, 116 issues

| # | Rule Key | Description | Severity | Issues | Tested |
|---|----------|-------------|----------|--------|--------|
| 1 | txt:Disallow_FLOAT_DOUBLE | Disallow FLOAT/DOUBLE/REAL -- prefer NUMBER(p,s) | MAJOR | 35 | ✓ `rule_20` |
| 2 | txt:Keywords_must_be_UPPER | SQL keywords must be UPPERCASE | MINOR | 31 | ✓ `rule_29` |
| 3 | txt:Disallow_VARCHAR_without_length | Disallow VARCHAR without explicit length | MINOR | 20 | ✓ `rule_21` |
| 4 | txt:Disallow_usage_of_TIMESTAMP_types_other_than_TIMESTAMP_TZ | Disallow TIMESTAMP_NTZ and TIMESTAMP_LTZ | MAJOR | 10 | ✓ `rule_07` |
| 5 | txt:Disallow_hardcoded_Use_DATABASE__SCHEMA__or_ROLE_statements | Disallow hardcoded USE DATABASE, SCHEMA, or ROLE | CRITICAL | 9 | ✓ `rule_06` |
...
| 9 | txt:JOIN_without_ON_clause | JOIN without ON clause | MAJOR | 1 | ✓ `rule_30` |
| 10 | txt:Implicit_alias_missing_AS | Implicit alias (missing AS keyword) | MINOR | 1 | ✓ `rule_31` |
| 11 | txt:Unnecessary_ELSE_NULL | Unnecessary ELSE NULL in CASE | MINOR | 0 | ✓ `rule_32` |
...
| 18 | txt:Stream_name_pattern | Stream names must follow DOM+COMP_MAT_SM_ pattern | MAJOR | 0 | ✓ `rule_37` |
| 19 | txt:Stored_Procedure_name_pattern | Stored Procedure names must follow DOM+COMP_MAT_SP_ pattern | MAJOR | 0 | ✓ `rule_27` |
| 20 | txt:File_Format_name_pattern | File Format names must follow DOM+COMP_MAT_FF_ pattern | MAJOR | 0 | ✓ `rule_26` |
| 21 | txt:Stage_name_pattern | Stage names must follow DOM+COMP_MAT_ST_ pattern | MAJOR | 0 | ✓ `rule_13` |
| 22 | txt:Task_name_pattern | Task names must follow DOM+COMP_MAT_TK_ pattern | MAJOR | 0 | ✓ `rule_28` |
| 23 | txt:View_name_pattern | View names must follow DOM+COMP_MAT_VW_ pattern | MAJOR | 0 | ✓ `rule_11` |
| 24 | txt:Dynamic_Table_name_pattern | Dynamic Table names must follow DOM+COMP_MAT_DT_ pattern | MAJOR | 0 | ✓ `rule_12` |
| 25 | txt:Table_name_pattern | Table names must follow DOM+COMP_MAT_TB_ pattern | MAJOR | 0 | ✓ `rule_10` |
...
| 28 | txt:Schema_must_have_maturity_prefix | Schema names must follow DOMAIN_MATURITY_ prefix | MAJOR | 0 | ✓ `rule_08` |
...
| 31 | txt:Disallow_CREATE_statements_with_hardcoded_database_or_schema_prefix | Disallow CREATE with hardcoded database/schema prefix | MAJOR | 0 | ✓ `rule_03` |
| 32 | txt:Disallow_ORDER_BY_in_views | Disallow ORDER BY in view definitions | MAJOR | 0 | ✓ `rule_23` |
| 33 | txt:Disallow_dropping_objects_without_IF_EXISTS | Disallow dropping objects without IF EXISTS | MAJOR | 0 | ✓ `rule_05` |
...
| 40 | txt:Enforce__maturity_level__Code_at_Positions_5_7 | Enforce maturity-level code at positions 5-7 | CRITICAL | 0 | ✓ `rule_08` |
...
## SQL Code Checker Rules (SQLCC:) — 20 rules, 53 issues

| # | Rule Key | Description | Severity | Issues | Tested |
|---|----------|-------------|----------|--------|--------|
| 1 | SQLCC:C022 | Non-materialized view found | MAJOR | 27 | ✓ |
| 2 | SQLCC:C030 | File does not start with multiline/header comment | MINOR | 8 | ✓ |
| 3 | SQLCC:C017 | ORDER BY clause does not contain order (ASC/DESC) | MINOR | 5 | ✓ |
| 4 | SQLCC:C002 | SELECT * is used | MINOR | 4 | ✓ |
| 5 | SQLCC:C009 | Non-sargable statement used | MAJOR | 4 | ✓ |
| 6 | SQLCC:C003 | INSERT statement without columns listed | MINOR | 2 | ✓ |
| 7 | SQLCC:C023 | Cartesian join found | MAJOR | 2 | ✓ |
| 8 | SQLCC:C012 | Comparison operator (=, <>) to check if value is null | MAJOR | 1 | ✓ |
| 9 | SQLCC:C001 | SLEEP/WAITFOR is used (SQL Server only) | MINOR | 0 | n/a |
| 10 | SQLCC:C004 | ORDER BY clause contains positional references | MINOR | 0 | ✓ |
...
| 16 | SQLCC:C014 | OR verb is used in a WHERE clause | MAJOR | 0 | ✓ |
| 17 | SQLCC:C015 | UNION operator is used | MAJOR | 0 | ✓ |
| 18 | SQLCC:C016 | IN/NOT IN is used for a subquery | MAJOR | 0 | ✓ |
| 19 | SQLCC:C020 | HINT is used (SQL Server only) | MINOR | 0 | n/a |
| 20 | SQLCC:C021 | COMMIT is missing (SQL Server only) | MINOR | 0 | n/a |

---

## SQLFluff Rules (external) — 26 rules, 523 issues
...
- Only **44 of 93 rules** triggered issues on this project's codebase
